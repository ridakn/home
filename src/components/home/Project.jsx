...
const Project = () => {
  ...
  return (
    <div id="projects" className="jumbotron jumbotron-fluid m-0" style={{backgroundColor:'#fdfaff'}}>
      {projectsArray.length && (
        <div className="container container-fluid" >
          <h1 className="display-4 pb-5 text-center"><strong>{projectHeading}</strong></h1>
          <div className="row">
